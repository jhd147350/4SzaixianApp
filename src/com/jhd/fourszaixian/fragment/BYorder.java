...
public class BYorder extends Fragment {

	private ListView byorder_lv;
	private TextView byorder_tv;
	private List<Order> list = new ArrayList<Order>();

	TimeTranslation t = new TimeTranslation();
	final String type = "保养";
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		View view = inflater.inflate(R.layout.orderp1, null);
		byorder_lv = (ListView) view.findViewById(R.id.byorder_lv);
		byorder_tv = (TextView) view.findViewById(R.id.byorder_tv);
...
//					System.out.println(order.toString());
				...
				if(list.size()!=0){
					...
					byorder_lv.setAdapter(adapter);
				}
				else{
					byorder_tv.setText("暂时没有订单！！�?");
