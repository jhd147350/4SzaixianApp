...
public class MyShop02 extends Fragment {

	private ListView shop02_lv;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view  = inflater.inflate(R.layout.myshop02, null);
		shop02_lv = (ListView) view.findViewById(R.id.myshop02_lv);
		shop_tv = (TextView) view.findViewById(R.id.shop2_tv);
		System.out.println("----------进入shop02--------------");
		head_brand = (TextView) view.findViewById(R.id.shop02_head).findViewById(R.id.shop_brand);
		head_series = (TextView) view.findViewById(R.id.shop02_head).findViewById(R.id.shop_series);
		head_model = (TextView) view.findViewById(R.id.shop02_head).findViewById(R.id.shop_models);
		head_time = (TextView) view.findViewById(R.id.shop02_head).findViewById(R.id.shop_time);
...
//					c.setCarImg(js.getString("car_img"));
					...
					if(c.getUid().equals(null)){
						...
						shopByType(c.getCarBrand(), c.getCarSeries(), c.getCarModel(), type);
					}
				} catch (JSONException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
	...
	private  void shopByType(String brand,String series,String model,String type){
